...
#define botao A0                       //Porta em que o botão está sendo lido
#define ledVerde LED_D0                    //Porta em que o LED verde está conectado
#define ledAmarelo LED_D1                   //Porta em que o LED amarelo está conectado
#define ledVermelho LED_D2                  //Porta em que o LED Vermelho está conectado
#define ledAzul LED_D3
#define s1 D0
#define s2 D1
#define s3 D2
#define s4 D3
...
void contagem() {
  ...
  if (contador >= 4) {                 //Se o contador for maior ou igual a 4 significa que o botão foi pressionado 4 vezes ou mais
    ...
    digitalWrite(ledAzul, HIGH);    //Apaga o LED vermelho
    digitalWrite(s1,HIGH);
    digitalWrite(s2,HIGH);
    digitalWrite(s3,HIGH);
   ...
   if (contador >= 5) {                 //Se o contador for maior ou igual a 4 significa que o botão foi pressionado 4 vezes ou mais
